...
export default function ModernWeddingTemplate() {
  ...
  // Show loading screen
  if (isLoading) {
    return <LoadingTemplate2 groomInitial="A" brideInitial="E" />;
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-teal-50 relative overflow-hidden">
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-4 justify-center md:justify-start">
                  ...
                  <span className="text-xl font-medium text-gray-800">June 15, 2026</span>
                </div>
              </motion.div>
            </motion.div>
          ...
          <div className="grid grid-cols-12 gap-6 auto-rows-[280px]">
            ...
            >
              <div
                ...
                style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1606800052052-a08af7148866?w=1200&q=80")' }}
              ></div>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=800&q=80")' }}
              ></div>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=800&q=80")' }}
              ></div>
            ...
            >
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=800&q=80")' }}
              ></div>
      ...
      <section className="py-32 px-6 bg-gradient-to-b from-white to-emerald-50 relative overflow-hidden">
        {/* Background decorative elements - Wedding Themed */}
        <motion.div
              ...
              {[
                {
                  ...
                  bgPattern: 'radial-gradient(circle at 20% 50%, rgba(16, 185, 129, 0.15) 0%, transparent 50%)'
                },
                {
                  time: '5:30 PM',
                  title: 'Cocktail Hour',
                  ...
                  bgPattern: 'radial-gradient(circle at 80% 30%, rgba(20, 184, 166, 0.15) 0%, transparent 50%)'
                },
                {
                  time: '6:30 PM',
                  ...
                  color: 'from-emerald-400 to-teal-500',
                  bgPattern: 'radial-gradient(circle at 50% 80%, rgba(16, 185, 129, 0.15) 0%, transparent 50%)'
                },
                {
                  time: '8:00 PM',
                  title: 'First Dance',
                  ...
                  bgPattern: 'radial-gradient(circle at 30% 70%, rgba(6, 182, 212, 0.15) 0%, transparent 50%)'
                },
                {
                  time: '8:30 PM',
                  title: 'Cake Cutting',
                  ...
                  bgPattern: 'radial-gradient(circle at 70% 40%, rgba(20, 184, 166, 0.15) 0%, transparent 50%)'
                },
                {
                  time: '9:00 PM',
                ...
                >
                  <div
                    ...
                    style={{ background: event.bgPattern }}
                  >
                    ...
                    {/* Icon */}
                    <div className={`w-20 h-20 bg-gradient-to-br ${event.color} rounded-2xl flex items-center justify-center text-white mb-6 shadow-xl group-hover:scale-110 transition-transform duration-300`}>
                      {event.icon}
                    </div>
                    ...
                    <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${event.color}`}></div>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              <div className="aspect-video rounded-3xl overflow-hidden mb-6 border-4 border-white shadow-2xl">
                <div
                  ...
                  style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1519167758481-83f29da8fd22?w=1000&q=80")' }}
                ></div>
              </div>
              <div className="space-y-4 glass-morphism p-6 rounded-2xl border-2 border-emerald-100">
                <h3 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                  <span className="w-2 h-8 bg-gradient-to-b from-emerald-400 to-teal-500 rounded-full"></span>
                  The Ceremony
                </h3>
                <div className="flex items-start gap-3 text-gray-600">
                  <Calendar className="w-5 h-5 mt-1 text-emerald-500" />
                  <div>
                    <div className="font-semibold text-gray-900">June 15, 2026</div>
                    <div>4:00 PM</div>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-600">
                  <MapPin className="w-5 h-5 mt-1 text-emerald-500" />
                  <div>
                    <div className="font-semibold text-gray-900">The Garden Estate</div>
                    <div>123 Botanical Lane, Green Valley, GV 12345</div>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="aspect-video rounded-3xl overflow-hidden mb-6 border-4 border-white shadow-2xl">
                <div
                  className="w-full h-full bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                  style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1464366400600-7168b8af9bc3?w=1000&q=80")' }}
                ></div>
              </div>
              <div className="space-y-4 glass-morphism p-6 rounded-2xl border-2 border-teal-100">
                <h3 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                  <span className="w-2 h-8 bg-gradient-to-b from-teal-400 to-cyan-500 rounded-full"></span>
                  The Reception
                </h3>
                <div className="flex items-start gap-3 text-gray-600">
                  <Calendar className="w-5 h-5 mt-1 text-teal-500" />
                  <div>
                    <div className="font-semibold text-gray-900">June 15, 2026</div>
                    <div>6:30 PM - Midnight</div>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-gray-600">
                  <MapPin className="w-5 h-5 mt-1 text-teal-500" />
                  <div>
                    <div className="font-semibold text-gray-900">The Pavilion</div>
                    <div>456 Celebration Gardens, Green Valley, GV 12345</div>
                  </div>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: <Camera className="w-8 h-8" />, title: 'Share Photos', desc: 'Tag #EmmaAndAlex2026', color: 'from-teal-400 to-cyan-500' },
      ...
      <section className="py-32 px-6 bg-white relative overflow-hidden">
        ...
        {/* Wedding ring decorations around RSVP */}
        <motion.div
      ...
      <footer className="py-16 px-6 bg-gradient-to-b from-emerald-50 to-teal-100 text-center relative">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-gray-600 font-medium">Emma & Alex • June 15, 2026</p>
