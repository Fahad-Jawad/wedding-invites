...
import { TextEditor, DateEditor, ImageEditor } from '@/components/EditorForms';
...
export default function EditableTemplate3() {
  ...
  const [content, setContent] = useState({
    brideName: 'Emma',
    groomName: 'James',
    weddingDate: '2026-06-15T15:00:00',
    venue: 'The Grand Ballroom, NYC',
    heroImage: 'https://images.unsplash.com/photo-1517861807225-0b7a64c8a500?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80',
    heroQuote: 'Where flowers bloom, so does hope. We invite you to witness the blooming of our love.',
    aboutImage: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80',
    storyTitle: 'From Serendipity to Forever',
    story1: 'Our journey began on a rainy afternoon at the New York Public Library. James reached for the same book on Renaissance art that I was about to take. That accidental meeting sparked a conversation that lasted until closing time.',
    story2: 'Five years later, he proposed at that same library under the gilded ceilings, surrounded by the stories that first brought us together. We\'re excited to begin our own forever story with you by our side.',
    timeline: [
      {
        time: '3:00 PM',
        title: 'Ceremony',
        description: 'Join us for an intimate ceremony surrounded by blooming gardens and heartfelt vows.',
        image: 'https://images.unsplash.com/photo-1519741497676-853586c6f96c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80'
      },
      {
        time: '4:30 PM',
        title: 'Cocktail Hour',
        description: 'Sip signature cocktails and enjoy hors d\'oeuvres while string quartets set the romantic mood.',
      ...
      },
      {
        time: '6:00 PM',
        title: 'Reception',
        description: 'Dine under crystal chandeliers as we celebrate with dinner, toasts, and our first dance.',
        image: 'https://images.unsplash.com/photo-1519335353930-9e2c2d5f8659?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80'
      },
      {
        time: '10:00 PM',
        title: 'Farewell',
        description: 'Send us off with sparklers as we begin our journey as husband and wife.',
        image: 'https://images.unsplash.com/photo-1511282347536-d97c6e9f9a73?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80'
      }
    ],
    footerQuote: 'Love is composed of a single soul inhabiting two bodies'
  });
  ...
  // Memoized countdown calculation - MUST be before conditional returns
  const calculateTimeLeft = useCallback(() => {
    const now = new Date();
    const weddingTime = new Date(content.weddingDate);
  ...
  useEffect(() => {
    const loadSavedData = async () => {
      try {
        ...
        if (savedData && savedData.templateNumber === 3) {
  ...
  const handleSave = async () => {
    await saveTemplate(3, content);
  };

  if (status === 'loading' || !isDataLoaded) {
    const groomInitial = content.groomName?.[0]?.toUpperCase() || 'J';
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(
      `Thank you for your RSVP, ${formData.name}! We have noted ${formData.guests} guest(s).`
    );
  ...
  return (
    <>
      ...
      <div className='bg-rose-50 text-stone-800 font-sans relative overflow-hidden'>
        ...
        >
          ...
          <EditableWrapper
            ...
            className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-8 sm:mt-12 md:mt-16"
          >
            <motion.h1
              variants={fadeInUp}
              initial='initial'
        ...
        >
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
            <EditableWrapper
              onEdit={() => {
                setEditingSection('aboutImage');
                setTempContent({ aboutImage: content.aboutImage });
              }}
            ...
            <EditableWrapper
              onEdit={() => {
                ...
                setTempContent({
                  ...
                  story1: content.story1,
                  story2: content.story2
                });
              }}
              label="Edit Story"
                ...
                <form onSubmit={handleSubmit} className='space-y-8'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    <div>
                      <label
                        htmlFor='name'
                        className='block text-lg font-medium text-stone-700 mb-3 flex items-center space-x-2'
                      >
                      ...
                      <input
                        ...
                        required
                        className='w-full px-6 py-4 rounded-2xl border border-stone-300 focus:ring-3 focus:ring-amber-400 focus:border-transparent transition-all duration-300'
                      />
                    </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span>Special Requests or Messages</span>
                    </label>
                    <textarea
                      id='message'
                      name='message'
                      ...
                      rows='4'
                      className='w-full px-6 py-4 rounded-2xl border border-stone-300 focus:ring-3 focus:ring-amber-400 focus:border-transparent transition-all duration-300'
                      placeholder='Dietary restrictions, song requests, or personal messages...'
                    ></textarea>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    type='submit'
                    className='w-full bg-gradient-to-r from-amber-500 to-pink-500 text-white font-bold py-5 px-8 rounded-2xl text-xl shadow-xl hover:shadow-2xl transition-all duration-300 relative overflow-hidden'
                  >
                    <span className='relative z-10 flex items-center justify-center space-x-3'>
                      <Heart size={24} />
                      <span>Submit RSVP</span>
                    </span>
                    <div className='absolute inset-0 bg-gradient-to-r from-amber-600 to-pink-600 opacity-0 hover:opacity-100 transition-opacity duration-300'></div>
                  </motion.button>
                </form>
              </div>
            </motion.div>
        ...
        <footer className='py-16 px-4 bg-gradient-to-t from-stone-100 to-rose-50/50 border-t border-stone-200 relative'>
          ...
          <EditableWrapper
            onEdit={() => {
              ...
              setTempContent({ footerQuote: content.footerQuote });
            }}
            label="Edit Footer Quote"
          >
            <div className='max-w-4xl mx-auto text-center relative z-10'>
      ...
      >
        ...
        <TextEditor
          label="Venue"
          value={tempContent.venue || content.venue}
          onChange={(val) => setTempContent(prev => ({ ...prev, venue: val }))}
          placeholder="e.g., The Grand Ballroom, NYC"
        />
        <TextEditor
          label="Hero Quote"
          value={tempContent.heroQuote || content.heroQuote}
          onChange={(val) => setTempContent(prev => ({ ...prev, heroQuote: val }))}
          multiline
          placeholder="Enter your hero quote"
        />
      </EditorDrawer>

      {/* About Image Editor */}
      <EditorDrawer
        isOpen={editingSection === 'aboutImage'}
        onClose={() => setEditingSection(null)}
        title="Edit About Image"
      >
        <ImageEditor
          label="About Section Image"
          value={tempContent.aboutImage !== content.aboutImage ? tempContent.aboutImage : ''}
          onChange={(val) => setTempContent(prev => ({ ...prev, aboutImage: val }))}
          placeholder={content.aboutImage}
          autoFocus
        />
      </EditorDrawer>
      ...
      >
        <TextEditor
          label="Story Title"
          value={tempContent.storyTitle || content.storyTitle}
          onChange={(val) => setTempContent(prev => ({ ...prev, storyTitle: val }))}
          autoFocus
          placeholder="Enter story title"
        />
        <TextEditor
          label="First Paragraph"
          value={tempContent.story1 || content.story1}
          onChange={(val) => setTempContent(prev => ({ ...prev, story1: val }))}
          multiline
          placeholder="Tell how you met..."
        />
        <TextEditor
          label="Second Paragraph"
          value={tempContent.story2 || content.story2}
          onChange={(val) => setTempContent(prev => ({ ...prev, story2: val }))}
          multiline
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center justify-between mb-4">
            <label className="text-sm font-semibold text-gray-700">Timeline Events</label>
            <button
              type="button"
              onClick={() => {
                const newTimeline = [...(tempContent.timeline || content.timeline), {
                  time: '',
                  title: '',
                  description: '',
                  image: ''
                }];
                setTempContent(prev => ({ ...prev, timeline: newTimeline }));
              }}
          ...
          {(tempContent.timeline || content.timeline).map((event, index) => (
            <div key={index} className="p-4 border-2 border-gray-200 rounded-xl space-y-3 relative">
              <button
                type="button"
                onClick={() => {
                  const newTimeline = (tempContent.timeline || content.timeline).filter((_, i) => i !== index);
                  setTempContent(prev => ({ ...prev, timeline: newTimeline }));
                }}
              ...
              <TextEditor
                ...
                onChange={(val) => {
                  const newTimeline = [...(tempContent.timeline || content.timeline)];
                  newTimeline[index].description = val;
                  setTempContent(prev => ({ ...prev, timeline: newTimeline }));
                }}
                multiline
              ...
              <ImageEditor
                label="Event Image"
                value={tempContent.timeline?.[index]?.image !== content.timeline[index]?.image ? tempContent.timeline?.[index]?.image : ''}
                onChange={(val) => {
                  const newTimeline = [...(tempContent.timeline || content.timeline)];
                  newTimeline[index].image = val;
                  setTempContent(prev => ({ ...prev, timeline: newTimeline }));
                }}
                placeholder={content.timeline[index]?.image || ''}
              />
            </div>
          ))}
        </div>
      ...
      <EditorDrawer
        ...
        onClose={() => setEditingSection(null)}
        title="Edit Footer Quote"
      >
        <TextEditor
          label="Footer Quote"
          value={tempContent.footerQuote || content.footerQuote}
          onChange={(val) => setTempContent(prev => ({ ...prev, footerQuote: val }))}
          multiline
          autoFocus
