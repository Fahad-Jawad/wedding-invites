...
export default function EditableTemplate4() {
  ...
  const [content, setContent] = useState({
    ...
    venueFullAddress: '789 Enchanted Avenue, Moonlight Bay, CA 90210',
    receptionVenue: 'The Crystal Ballroom',
    receptionTime: '6:00 PM - Midnight',
    tagline: 'Together with their families, invite you to celebrate the beginning of their forever',
    heroImage: 'https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=400&q=80',
    storyImage: 'https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=800&q=80',
    ceremonyImage: 'https://images.unsplash.com/photo-1519167758481-83f29da8fd22?w=800&q=80',
    receptionImage: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=800&q=80',
    story: [
      {
        title: 'First Meeting',
  ...
  useEffect(() => {
    const loadSavedData = async () => {
      try {
        ...
        if (savedData && savedData.templateNumber === 4) {
  ...
  // Countdown calculation - MUST be before conditional returns
      ...
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 flex items-center justify-center">
        <div className="text-center">
          <motion.div
            ...
            className="w-16 h-16 border-4 border-rose-300 border-t-rose-600 rounded-full mx-auto mb-4"
          />
          <p className="text-xl text-gray-600 font-serif">Loading your invitation...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 overflow-x-hidden relative">
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-rose-600 text-sm tracking-[0.3em] uppercase font-semibold">
                      ...
                      <div className="bg-white/60 backdrop-blur-md rounded-2xl px-6 py-4 border border-rose-200/50 hover:border-rose-300 hover:shadow-lg transition-all">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 font-semibold">{content.eventTime}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="bg-white/60 backdrop-blur-md rounded-2xl px-6 py-4 border border-orange-200/50 hover:border-orange-300 hover:shadow-lg transition-all">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-800 font-semibold">{content.venue}</p>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <EditableWrapper
                onEdit={() => {
                  ...
                  setTempContent({ story: content.story });
                }}
                label="Edit Story"
              >
                <motion.div
                  ...
                  {content.story.map((story, index) => (
                    ...
                    >
                      <div className={`flex-shrink-0 w-12 h-12 bg-gradient-to-br ${
                        index === 0 ? 'from-rose-500 to-pink-500' :
                        index === 1 ? 'from-pink-500 to-orange-500' :
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`absolute inset-0 rounded-3xl bg-gradient-to-br ${
                          ...
                          index === 2 ? 'from-purple-500 to-orange-500' :
                          index === 3 ? 'from-orange-500 to-rose-500' :
                        ...
                        <div className="relative mb-4">
                          <motion.div
                            className={`inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r ${
                              index === 0 ? 'from-rose-500 to-pink-500' :
                              index === 1 ? 'from-pink-500 to-purple-500' :
                              index === 2 ? 'from-purple-500 to-orange-500' :
                              index === 3 ? 'from-orange-500 to-rose-500' :
                          ...
                          <div className={`relative w-16 h-16 ${
                            ...
                            <div className={
                              ...
                              {index === 0 ? <Heart className="w-6 h-6" /> :
                               ...
                               index === 2 ? <Cake className="w-6 h-6" /> :
                               index === 3 ? <Music className="w-6 h-6" /> :
        ...
        <section className="relative py-24 px-6 bg-white/50">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <EditableWrapper
                onEdit={() => {
                  setEditingSection('venue');
                  setTempContent({
                    venue: content.venue,
                    venueFullAddress: content.venueFullAddress,
                    eventTime: content.eventTime,
                    ceremonyImage: content.ceremonyImage
                  });
                }}
                  ...
                  <div className="relative h-full">
                    ...
                    <div className="relative bg-white/70 backdrop-blur-xl rounded-3xl overflow-hidden shadow-xl border border-white/50 h-full">
                      ...
                      <div className="p-8">
                        ...
                        <p className="text-gray-600 mb-4">
                          Same Venue<br />
                          {content.venueFullAddress.split(',').slice(1).join(',')}
                        </p>
                        <div className="flex items-center gap-2 text-gray-600 mb-6">
        ...
        <section className="relative py-24 px-6">
          <div className="container mx-auto max-w-3xl">
            <EditableWrapper
              onEdit={() => {
                setEditingSection('rsvp');
                setTempContent({ rsvpDeadline: content.rsvpDeadline });
              }}
              label="Edit RSVP Deadline"
            >
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="h-px w-32 bg-gradient-to-r from-transparent via-rose-300 to-transparent mx-auto mb-4"></div>
                <p className="text-gray-600 text-lg italic">Please respond by {content.rsvpDeadline}</p>
              </motion.div>
            </EditableWrapper>
          ...
          <div className="container mx-auto text-center max-w-4xl">
            <EditableWrapper
              onEdit={() => {
                ...
                setTempContent({
                  footerMessage: content.footerMessage
                });
              }}
              label="Edit Footer"
            >
      ...
      >
        ...
        <TextEditor
          label="Event Time"
          value={tempContent.eventTime || content.eventTime}
          onChange={(val) => setTempContent(prev => ({ ...prev, eventTime: val }))}
        ...
        <TextEditor
          ...
          placeholder="e.g., Crystal Garden"
        />
        <TextEditor
          label="Tagline"
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center justify-between mb-4">
            <label className="text-sm font-semibold text-gray-700">Story Sections</label>
            <button
              type="button"
              onClick={() => {
                const newStory = [...(tempContent.story || content.story), {
                  title: '',
                  description: ''
                }];
                setTempContent(prev => ({ ...prev, story: newStory }));
              }}
          ...
          {(tempContent.story || content.story).map((section, index) => (
            <div key={index} className="p-4 border-2 border-gray-200 rounded-xl space-y-3 relative">
              <button
                type="button"
                onClick={() => {
                  const newStory = (tempContent.story || content.story).filter((_, i) => i !== index);
                  setTempContent(prev => ({ ...prev, story: newStory }));
                }}
              ...
              <TextEditor
                ...
                onChange={(val) => {
                  const newStory = [...(tempContent.story || content.story)];
                  newStory[index].description = val;
                  setTempContent(prev => ({ ...prev, story: newStory }));
                }}
                multiline
      ...
      {/* Venue Editor */}
      <EditorDrawer
        isOpen={editingSection === 'venue'}
        onClose={() => setEditingSection(null)}
        title="Edit Ceremony Venue"
      >
        <TextEditor
          label="Venue Name"
          value={tempContent.venue || content.venue}
        ...
        <TextEditor
          label="Full Address"
          value={tempContent.venueFullAddress || content.venueFullAddress}
          onChange={(val) => setTempContent(prev => ({ ...prev, venueFullAddress: val }))}
          multiline
        ...
        <ImageEditor
          ...
          value={tempContent.ceremonyImage !== content.ceremonyImage ? tempContent.ceremonyImage : ''}
          onChange={(val) => setTempContent(prev => ({ ...prev, ceremonyImage: val }))}
          placeholder={content.ceremonyImage}
        />
      </EditorDrawer>

      {/* Reception Editor */}
      <EditorDrawer
        isOpen={editingSection === 'reception'}
        onClose={() => setEditingSection(null)}
        title="Edit Reception Venue"
      >
        <TextEditor
          label="Reception Venue Name"
          value={tempContent.receptionVenue || content.receptionVenue}
          onChange={(val) => setTempContent(prev => ({ ...prev, receptionVenue: val }))}
          autoFocus
          placeholder="e.g., The Crystal Ballroom"
        />
        <TextEditor
          label="Reception Time"
          value={tempContent.receptionTime || content.receptionTime}
          onChange={(val) => setTempContent(prev => ({ ...prev, receptionTime: val }))}
          placeholder="e.g., 6:00 PM - Midnight"
        />
        <ImageEditor
          label="Reception Image"
          value={tempContent.receptionImage !== content.receptionImage ? tempContent.receptionImage : ''}
          onChange={(val) => setTempContent(prev => ({ ...prev, receptionImage: val }))}
          placeholder={content.receptionImage}
        />
      </EditorDrawer>

      {/* RSVP Editor */}
      <EditorDrawer
        isOpen={editingSection === 'rsvp'}
        onClose={() => setEditingSection(null)}
        title="Edit RSVP Deadline"
      >
        <TextEditor
          label="RSVP Deadline"
          value={tempContent.rsvpDeadline || content.rsvpDeadline}
          onChange={(val) => setTempContent(prev => ({ ...prev, rsvpDeadline: val }))}
          autoFocus
          placeholder="e.g., August 1st, 2026"
        />
      </EditorDrawer>
      ...
      >
        <TextEditor
          ...
          value={tempContent.footerMessage || content.footerMessage}
          onChange={(val) => setTempContent(prev => ({ ...prev, footerMessage: val }))}
          autoFocus
