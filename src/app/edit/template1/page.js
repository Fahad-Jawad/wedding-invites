...
import { TextEditor, DateEditor, ImageEditor, TimelineEditor, LocationEditor } from '@/components/EditorForms';
...
export default function EditableTemplate1() {
  ...
  const [content, setContent] = useState({
    ...
    story1: 'Five years ago, fate brought us together at a small coffee shop in the heart of the city. What started as a chance encounter over a shared table and a conversation about books quickly blossomed into something beautiful and profound.',
    story2: 'From spontaneous road trips to quiet evenings at home, from adventures across continents to building our future together, every moment has been a testament to the love we share. Now, we\'re ready to embark on our greatest adventure yet.',
  ...
  useEffect(() => {
    const loadSavedData = async () => {
      try {
        ...
        if (savedData && savedData.templateNumber === 1) {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      {/* Hero Section with Better Spacing - EDITABLE */}
        ...
        >
          ...
          <EditableWrapper
            onEdit={() => {
              ...
              setTempContent({ weddingDate: content.weddingDate });
            }}
            label="Edit Wedding Date"
          >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xl md:text-2xl font-semibold text-gray-800">
                    {new Date(content.weddingDate).toLocaleDateString('en-US', {
                      ...
                      month: 'long',
                      day: 'numeric'
                    })} • {new Date(content.weddingDate).toLocaleTimeString('en-US', {
                      hour: 'numeric',
                      minute: '2-digit'
                    })}
                  </div>
      ...
      {/* About Section with Enhanced Images - EDITABLE */}
      <section className="py-32 px-4 relative bg-gradient-to-b from-white to-rose-50">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-20">
            <EditableWrapper
              onEdit={() => {
                setEditingSection('storyImage');
                setTempContent({ storyImage: content.storyImage });
              }}
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] group">
                  <div
                    ...
                    style={{
                      backgroundImage: `url("${content.storyImage}")`
                    }}
                  ></div>
          ...
          {/* Additional couple images - EDITABLE */}
          <EditableWrapper
            onEdit={() => {
              setEditingSection('gallery');
              setTempContent({ galleryImages: content.galleryImages });
            }}
            label="Edit Gallery Images"
          >
            <motion.div
              initial={{ opacity: 0, y: 60 }}
              whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-32 px-4 relative bg-white">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <EditableWrapper
              onEdit={() => {
                setEditingSection('venueImage');
                setTempContent({ venueImage: content.venueImage });
              }}
              label="Edit Venue Image"
            >
              <motion.div
                initial={{ opacity: 0, x: -60 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-video group">
                  <div
                    className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110"
                    style={{
                      backgroundImage: `url("${content.venueImage}")`
                    }}
                  ></div>
                  <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-8 text-white z-10">
                    <h3 className="text-3xl font-serif mb-2">{content.locations[0]?.name || 'The Grand Cathedral'}</h3>
            ...
            <EditableWrapper
              onEdit={() => {
                ...
                setTempContent({ locations: content.locations });
              }}
                ...
                {content.locations.map((location, index) => (
                  <div key={index} className="flex items-start gap-4 bg-rose-50 p-6 rounded-xl border border-rose-100">
                    <div className="w-12 h-12 bg-gradient-to-br from-rose-400 to-pink-400 rounded-full flex items-center justify-center flex-shrink-0">
                      {index === 0 ? <MapPin className="w-6 h-6 text-white" /> : <Map className="w-6 h-6 text-white" />}
                    </div>
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-2">{location.type}</h4>
                      <p className="text-gray-600 whitespace-pre-line">{location.name}<br/>{location.address}</p>
                    </div>
                  </div>
                ))}
      ...
      {/* Event Schedule Section - EDITABLE */}
      <section className="py-32 px-4 relative bg-gradient-to-b from-white to-rose-50">
              ...
              <div className="space-y-16">
                {content.timeline.map((event, index) => {
                  ...
                  const icons = [
                    ...
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V4a2 2 0 00-2-2H6zm1 2a1 1 0 000 2h6a1 1 0 100-2H7zm6 7a1 1 0 011 1v3a1 1 0 11-2 0v-3a1 1 0 011-1zm-3 3a1 1 0 100 2h.01a1 1 0 100-2H10zm-4 1a1 1 0 011-1h.01a1 1 0 110 2H7a1 1 0 01-1-1zm1-4a1 1 0 100 2h.01a1 1 0 100-2H7zm2 1a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1zm4-4a1 1 0 100 2h.01a1 1 0 100-2H13zM9 9a1 1 0 011-1h.01a1 1 0 110 2H10a1 1 0 01-1-1zM7 8a1 1 0 000 2h.01a1 1 0 000-2H7z" clipRule="evenodd"/></svg>,
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>,
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd"/></svg>,
      ...
      <footer className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-gray-500 text-lg mb-8">
            {content.brideName} & {content.groomName} • {new Date(content.weddingDate).toLocaleDateString('en-US', {
              year: 'numeric',
              month: 'long',
              day: 'numeric'
            })}
      ...
      >
        ...
        <TextEditor
          ...
          multiline
          placeholder="Enter invitation tagline"
        />
        <ImageEditor
      ...
      >
        ...
        <div className="mt-4 p-4 bg-rose-50 rounded-lg">
          <p className="text-sm text-gray-600">The countdown timer and all date displays will update automatically</p>
        </div>
      </EditorDrawer>
      ...
      {/* Story Image Editor */}
      <EditorDrawer
        isOpen={editingSection === 'storyImage'}
        onClose={() => setEditingSection(null)}
        title="Edit Story Image"
      >
        <ImageEditor
          label="Story Section Image"
          value={tempContent.storyImage !== content.storyImage ? tempContent.storyImage : ''}
          onChange={(val) => setTempContent(prev => ({ ...prev, storyImage: val }))}
          placeholder={content.storyImage}
          autoFocus
        />
      </EditorDrawer>
      ...
      {/* Gallery Editor */}
      <EditorDrawer
        isOpen={editingSection === 'gallery'}
        onClose={() => setEditingSection(null)}
        title="Edit Gallery Images"
      >
        <div className="space-y-4">
          {content.galleryImages.map((placeholderImg, index) => {
            const currentValue = tempContent.galleryImages?.[index] || '';
            return (
              <ImageEditor
                key={index}
                ...
                onChange={(val) => {
                  const newImages = [...(tempContent.galleryImages || content.galleryImages)];
                  newImages[index] = val;
                  setTempContent(prev => ({ ...prev, galleryImages: newImages }));
                }}
      ...
      {/* Venue Image Editor */}
      <EditorDrawer
        isOpen={editingSection === 'venueImage'}
        onClose={() => setEditingSection(null)}
        title="Edit Venue Image"
      >
        <ImageEditor
          label="Venue Image"
          value={tempContent.venueImage !== content.venueImage ? tempContent.venueImage : ''}
          onChange={(val) => setTempContent(prev => ({ ...prev, venueImage: val }))}
          placeholder={content.venueImage}
          autoFocus
        />
      </EditorDrawer>
      ...
      {/* Locations Editor */}
      <EditorDrawer
        isOpen={editingSection === 'locations'}
        onClose={() => setEditingSection(null)}
        title="Edit Venue Locations"
      >
        <div className="space-y-6">
          {(tempContent.locations || content.locations).map((location, index) => (
            <div key={index} className="p-4 border-2 border-gray-200 rounded-xl space-y-3">
              ...
              <TextEditor
                label="Type (e.g., Ceremony Location, Reception Venue)"
                value={location.type}
                onChange={(val) => {
                  const newLocations = [...(tempContent.locations || content.locations)];
                  newLocations[index].type = val;
                  setTempContent(prev => ({ ...prev, locations: newLocations }));
                }}
                autoFocus={index === 0}
              />
              <TextEditor
              ...
              <TextEditor
                ...
                onChange={(val) => {
                  const newLocations = [...(tempContent.locations || content.locations)];
                  newLocations[index].address = val;
                  setTempContent(prev => ({ ...prev, locations: newLocations }));
                }}
                multiline
              />
